...
echo $form->field($generator, 'ns', ['template' => '{label}{beginWrapper}{input}{error}{endWrapper}{hint}', 'horizontalCssClasses' => ['wrapper'=>'col-sm-9 col-xs-12 col-12']])
...
echo $form->field($generator, 'generateRelations', ['template' => '{label}{beginWrapper}{input}{error}{endWrapper}{hint}', 'horizontalCssClasses' => ['wrapper'=>'col-sm-9 col-xs-12 col-12']])
	->dropDownList([
...
echo $form->field($generator, 'generateRelationsFromCurrentSchema', ['horizontalCssClasses' => ['wrapper'=>'col-sm-9 col-xs-12 col-12']])
	->checkbox()
	->label($generator->getAttributeLabel('generateRelationsFromCurrentSchema'));

echo $form->field($generator, 'generateLabelsFromComments', ['horizontalCssClasses' => ['wrapper'=>'col-sm-9 col-xs-12 col-12']])
	->checkbox()
	->label($generator->getAttributeLabel('generateLabelsFromComments'));

echo $form->field($generator, 'generateQuery', ['horizontalCssClasses' => ['wrapper'=>'col-sm-9 col-xs-12 col-12']])
	->checkbox()
	->label($generator->getAttributeLabel('generateQuery'));

echo $form->field($generator, 'queryNs', ['template' => '{label}{beginWrapper}{input}{error}{endWrapper}{hint}', 'horizontalCssClasses' => ['wrapper'=>'col-sm-9 col-xs-12 col-12']])
	->label($generator->getAttributeLabel('queryNs'));

echo $form->field($generator, 'queryClass', ['template' => '{label}{beginWrapper}{input}{error}{endWrapper}{hint}', 'horizontalCssClasses' => ['wrapper'=>'col-sm-9 col-xs-12 col-12']])
	->label($generator->getAttributeLabel('queryClass'));

echo $form->field($generator, 'queryBaseClass', ['template' => '{label}{beginWrapper}{input}{error}{endWrapper}{hint}', 'horizontalCssClasses' => ['wrapper'=>'col-sm-9 col-xs-12 col-12']])
...
echo $form->field($generator, 'useSchemaName', ['horizontalCssClasses' => ['wrapper'=>'col-sm-9 col-xs-12 col-12']])
	->checkbox()
	->label($generator->getAttributeLabel('useSchemaName'));

echo $form->field($generator, 'generateMessage', ['horizontalCssClasses' => ['wrapper'=>'col-sm-9 col-xs-12 col-12']])
	->checkbox()
	->label($generator->getAttributeLabel('generateMessage'));

echo $form->field($generator, 'generateEvents', ['horizontalCssClasses' => ['wrapper'=>'col-sm-9 col-xs-12 col-12']])
	->checkbox()
	->label($generator->getAttributeLabel('generateEvents'));

echo $form->field($generator, 'uploadPath[directory]', ['template' => '{label}{beginWrapper}{input}{error}{endWrapper}{hint}', 'horizontalCssClasses' => ['wrapper'=>'col-sm-9 col-xs-12 col-12']])
...
echo $form->field($generator, 'useGetFunction', ['horizontalCssClasses' => ['wrapper'=>'col-sm-9 col-xs-12 col-12']])
	->checkbox()
