...
class Generator extends \ommu\gii\Generator
{
	...
	public function rules()
	{
		return array_merge(parent::rules(), [
			[['db', 'migrationPath', 'tableName', 'migrationName', 'migrationTime', 'link'], 'filter', 'filter' => 'trim'],
			[['db', 'migrationPath', 'tableName', 'migrationName', 'migrationTime', 'link'], 'required'],
			...
			[['generateRelations', 'useModified'], 'boolean'],
	...
	{
		return array_merge(parent::stickyAttributes(), ['migrationPath', 'db', 'generateRelations', 'useTablePrefix', 'link']);
	}
