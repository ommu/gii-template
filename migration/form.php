...
echo $form->field($generator, 'migrationPath', ['template' => '{label}{beginWrapper}{input}{error}{endWrapper}{hint}', 'horizontalCssClasses' => ['wrapper'=>'col-md-9 col-sm-9 col-xs-12 col-12']])
	->label($generator->getAttributeLabel('migrationPath'));

echo $form->field($generator, 'migrationTime', ['template' => '{label}{beginWrapper}{input}{error}{endWrapper}{hint}', 'horizontalCssClasses' => ['wrapper'=>'col-md-9 col-sm-9 col-xs-12 col-12']])
	->label($generator->getAttributeLabel('migrationTime'))
	->widget('yii\widgets\MaskedInput', [
		'mask' => '999999_999999'
	]);

echo $form->field($generator, 'migrationName', ['template' => '{label}{beginWrapper}{input}{error}{endWrapper}{hint}', 'horizontalCssClasses' => ['wrapper'=>'col-md-9 col-sm-9 col-xs-12 col-12']])
...
echo $form->field($generator, 'generateRelations', ['horizontalCssClasses' => ['wrapper'=>'col-md-9 col-sm-9 col-xs-12 col-12']])
	->checkbox()
