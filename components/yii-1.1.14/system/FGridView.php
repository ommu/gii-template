 ...
 * @since 1.1
 */
class FGridView extends CBaseListView
{
	...
	public function registerClientScript()
	{
		...
		$options=array(
			...
			'afterAjaxUpdate'=>"js:function(){
				jQuery('#Model_creation_date').datepicker({'dateFormat':'yy-mm-dd'});
				var start = jQuery('#Model_creation_date').val();
				jQuery('#Model_creation_date').datepicker('setDate', start);
			}",
			*/
		);
